...
public class CheckersCanvas extends Canvas implements ActionListener, MouseListener {
    ...
    public CheckersCanvas() {
        ...
        board = new CheckersData(boardByte);
        doNewGame();
    }
...
//        bestMove = new GameTree(Difficulty.EASY);
//        if (currentPlayer == 2) {
//                newMove = bestMove.getBestMove(boardByte, Difficulty.EASY, true);
//             //g.drawRect(2 + newMove.fromCol*20, 2 + newMove.fromRow*20, 19, 19);
//
//            } else {
//
//                newMove = bestMove.getBestMove(boardByte, Difficulty.EASY, true);
    ...
    void doMakeMove(CheckersMove move) {
        ...
        if (currentPlayer == CheckersData.RED) {
            ...
            if (legalMoves == null) {
                ...
                bestMove = new GameTree(Difficulty.EASY);
                if (currentPlayer == 2) {
                    newMove = bestMove.getBestMove(boardByte, Difficulty.EASY, false);
                    //g.drawRect(2 + newMove.fromCol*20, 2 + newMove.fromRow*20, 19, 19);
